...
use khala_runtime::{opaque::Block, Hash, RuntimeApi};
...
pub fn build_import_queue(
    ...
    sp_consensus::DefaultImportQueue<Block, TFullClient<Block, RuntimeApi, RuntimeExecutor>>,
    sc_service::Error,
> {
...
pub async fn start_node(
    ...
    TaskManager,
    Arc<TFullClient<Block, khala_runtime::RuntimeApi, RuntimeExecutor>>,
)> {
    start_node_impl::<khala_runtime::RuntimeApi, RuntimeExecutor, _, _, _>(
        parachain_config,
        collator_key,
        polkadot_config,
        id,
