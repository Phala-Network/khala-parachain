...
pub struct ThalaParachainRuntimeExecutor;

impl sc_executor::NativeExecutionDispatch for ThalaParachainRuntimeExecutor {
    type ExtendHostFunctions = frame_benchmarking::benchmarking::HostFunctions;

    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        thala_parachain_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        thala_parachain_runtime::native_version()
    }
}
...
pub fn khala_parachain_build_import_queue(
    client: Arc<
        TFullClient<
            Block,
            khala_parachain_runtime::RuntimeApi,
            NativeElseWasmExecutor<KhalaParachainRuntimeExecutor>,
        >,
    >,
    config: &Configuration,
...
/// Start a Khala parachain node.
pub async fn start_khala_parachain_node(
    parachain_config: Configuration,
    polkadot_config: Configuration,
    id: ParaId,
) -> sc_service::error::Result<(
    ...
    start_node_impl::<khala_parachain_runtime::RuntimeApi, KhalaParachainRuntimeExecutor, _, _, _>(
        ...
        khala_parachain_build_import_queue,
        |client,
         prometheus_registry,
         telemetry,
         task_manager,
...
/// Build the import queue for the Thala parachain runtime.
pub fn thala_parachain_build_import_queue(
    client: Arc<
        TFullClient<
            Block,
            thala_parachain_runtime::RuntimeApi,
            NativeElseWasmExecutor<ThalaParachainRuntimeExecutor>,
        >,
    >,
    config: &Configuration,
    telemetry: Option<TelemetryHandle>,
...
/// Start a Thala parachain node.
pub async fn start_thala_parachain_node(
    parachain_config: Configuration,
    polkadot_config: Configuration,
    id: ParaId,
) -> sc_service::error::Result<(
    ...
    start_node_impl::<thala_parachain_runtime::RuntimeApi, ThalaParachainRuntimeExecutor, _, _, _>(
        parachain_config,
        polkadot_config,
        id,
        |_| Ok(Default::default()),
        thala_parachain_build_import_queue,
        |client,
         prometheus_registry,
         telemetry,
         task_manager,
