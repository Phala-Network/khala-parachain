...
pub type ChainSpec =
    sc_service::GenericChainSpec<phala_parachain_runtime::RuntimeGenesisConfig, Extensions>;
...
fn genesis(
...
) -> phala_parachain_runtime::RuntimeGenesisConfig {
    ...
    phala_parachain_runtime::RuntimeGenesisConfig {
        ...
        parachain_info: phala_parachain_runtime::ParachainInfoConfig {
            parachain_id: id,
            ..Default::default()
        },
