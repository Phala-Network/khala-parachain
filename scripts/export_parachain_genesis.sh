...
./target/production/khala-node export-genesis-wasm -r --chain khala-local-2004 > ./tmp/kernels/local-code.wasm
./target/production/khala-node export-genesis-state --chain khala-local-2004 > ./tmp/kernels/local-state.hex

./target/production/khala-node export-genesis-wasm -r --chain khala-local-2000 > ./tmp/kernels/local-code-2000.wasm
./target/production/khala-node export-genesis-state --chain khala-local-2000 > ./tmp/kernels/local-state-2000.hex
